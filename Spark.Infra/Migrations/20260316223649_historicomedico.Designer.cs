...
namespace Spark.Infra.Migrations
{
    ...
    [Migration("20260316223649_historicomedico")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Spark.Domain.Entities.Consulta", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Spark.Domain.Entities.ConsultaChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Spark.Domain.Entities.FichaClinica", b =>
                {
                    ...
                    b.Property<List<string>>("HistoricoMedico")
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("Spark.Domain.Entities.FilaAtendimento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("AnamnseId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Spark.Domain.Entities.UsuarioPaciente", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IsResponsavelLegal")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Spark.Domain.Entities.Consulta", b =>
                {
                    b.HasOne("Spark.Domain.Entities.Usuarios.Usuario", "UsuarioDoutor")
                        .WithMany()
                        .HasForeignKey("DoutorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Spark.Domain.Entities.Usuarios.Usuario", "UsuarioPaciente")
                        .WithMany()
                        .HasForeignKey("PacienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("UsuarioDoutor");
            ...
            modelBuilder.Entity("Spark.Domain.Entities.UsuarioPaciente", b =>
                {
                    b.HasOne("Spark.Domain.Entities.Usuarios.Usuario", "Paciente")
                        .WithMany()
                        .HasForeignKey("PacienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Spark.Domain.Entities.Usuarios.Usuario", "Responsavel")
                        .WithMany()
